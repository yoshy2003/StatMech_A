...
- 統計物理学入門として、**平衡状態の統計力学**を学ぶ。
  - ここで扱う内容は、「横糸としての統計物理学」の出発点に位置するものである。
  - 横糸としての統計物理学：平衡状態の統計力学・平衡ゆらぎの統計物理学・非平衡統計物理学・複雑系科学
...
- 乱数に基づく数値シミュレーションを行い、分布を通して統計力学の基礎を学ぶ
...
- [draft版・随時更新中](https://waseda.box.com/s/xozrws2nlrkb0iuim7ylyg5xiv3fqwmh)
  - 2状態系（2準位系・コイン投げ）と古典自由粒子系（単原子分子理想気体に相当）を題材として、平衡状態の統計力学を学ぶ
...
- 第Ⅰ部 <a href="#part01">基礎</a>
  ...
  - 第４章 グランドカノニカル分布
- 第Ⅱ部 <a href="#part02">ゆらぎと遷移</a>
  - 第５章 平衡状態のゆらぎ
  - 第６章 ミクロな状態間の遷移
- 第Ⅲ部 <a href="#part03">応用とモデル化</a>【準備中】
  - 第７章 外場・外力がはたらく系
  - 第８章 調和振動子系
  - 第９章 粒子数分布
